        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            ...
            leading: InkWell(
              ...
              onTap: () async {
                logFirebaseEvent('ADD_PRODUCT_PAGE_Icon_d2b3zd6f_ON_TAP');
            ...
            actions: [
              InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  logFirebaseEvent('ADD_PRODUCT_PAGE_Icon_p42djrui_ON_TAP');
                  logFirebaseEvent('Icon_navigate_to');
                      ...
                      child: Column(
                        ...
                        children: [
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                ...
                                child: Image.network(
                                  _model
                                      .uploadedFileUrl_uploadDataProduitUpdate,
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ),
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'ADD_PRODUCT_PAGE_UPLOAD_PHOTO_BTN_ON_TAP');
                                  logFirebaseEvent(
                                  ...
                                  if (selectedMedia != null &&
                                    ...
                                    safeSetState(() => _model
                                            .isDataUploading_uploadDataProduitUpdate =
                                        true);
                                    ...
                                    try {
                                      ...
                                      _model.isDataUploading_uploadDataProduitUpdate =
                                          false;
                                    }
                                    if (selectedUploadedFiles.length ==
                                        ...
                                        downloadUrls.length ==
                                            selectedMedia.length) {
                                      safeSetState(() {
                                        _model.uploadedLocalFile_uploadDataProduitUpdate =
                                            selectedUploadedFiles.first;
                                        _model.uploadedFileUrl_uploadDataProduitUpdate =
                                            downloadUrls.first;
                                      });
                                    } else {
                                      safeSetState(() {});
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 24.0, 0.0, 0.0),
                            child: StreamBuilder<List<CategoryProductRecord>>(
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'ADD_PRODUCT_PAGE_ADD_PRODUCT_BTN_ON_TAP');
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    ...
                                    backgroundColor: Color(0xFFBF1212),
                                  ),
                                );
                              },
                              text: 'Add Product',
