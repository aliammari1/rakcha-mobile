...
class _EditRoomWidgetState extends State<EditRoomWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'EditRoom'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('EDIT_ROOM_arrow_back_rounded_ICN_ON_TAP');
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: TextFormField(
                                        ...
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          hintText: widget.salle?.nbrPlaces
                                              .toString(),
                                          hintStyle: FlutterFlowTheme.of(
                                                  context)
                                              .bodySmall
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'EDIT_ROOM_PAGE_EDIT_Button_ON_TAP');
                                      logFirebaseEvent(
                                          'EDIT_Button_backend_call');

                                      await widget.salle!.reference.update({
                                        ...createSalleRecordData(
                                          nom: _model.nameTextController.text,
                                          nbrPlaces: int.tryParse(_model
                                              .numberofseatsTextController
                                              .text),
                                        ),
                                        ...mapToFirestore(
                                          {
