...
import 'a_dd_actor_model.dart';
export 'a_dd_actor_model.dart';

class ADdActorWidget extends StatefulWidget {
  const ADdActorWidget({super.key});

  static String routeName = 'ADdActor';
  static String routePath = '/aDdActor';

  @override
  State<ADdActorWidget> createState() => _ADdActorWidgetState();
}

class _ADdActorWidgetState extends State<ADdActorWidget> {
  late ADdActorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ADdActorModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'ADdActor'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('A_DD_ACTOR_arrow_back_rounded_ICN_ON_TAP');
                  ...
                  children: [
                    Padding(
                      ...
                      child: ClipRRect(
                        ...
                        child: Image.network(
                          _model.uploadedFileUrl_uploadDataZ68,
                          width: 150.0,
                          height: 201.0,
                          fit: BoxFit.cover,
                        ),
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'A_DD_ACTOR_PAGE_UPLOAD_IMAGE_BTN_ON_TAP');
                          ...
                          if (selectedMedia != null &&
                            ...
                            safeSetState(() =>
                                _model.isDataUploading_uploadDataZ68 = true);
                            ...
                            try {
                              ...
                              ScaffoldMessenger.of(context)
                                  .hideCurrentSnackBar();
                              _model.isDataUploading_uploadDataZ68 = false;
                            }
                            if (selectedUploadedFiles.length ==
                                    selectedMedia.length &&
                                downloadUrls.length == selectedMedia.length) {
                              safeSetState(() {
                                _model.uploadedLocalFile_uploadDataZ68 =
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'A_DD_ACTOR_PAGE_ADD_ACTOR_BTN_ON_TAP');
                          logFirebaseEvent('Button_validate_form');
                          if (_model.formKey.currentState == null ||
                              !_model.formKey.currentState!.validate()) {
                            return;
                          }
                          if (_model.uploadedFileUrl_uploadDataZ68.isEmpty) {
                            return;
                          }
                          ...
                          await ActorFilmRecord.collection
                              ...
                              .set(createActorFilmRecordData(
                                ...
                                image: _model.uploadedFileUrl_uploadDataZ68,
                              ));
                          logFirebaseEvent('Button_show_snack_bar');
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                'Actor added succefull',
                                style: TextStyle(
                                  color:
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'A_DD_ACTOR_LIST_OF_ACTORS_BTN_ON_TAP');
                          logFirebaseEvent('Button_navigate_to');
